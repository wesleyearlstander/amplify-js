...
/* harmony import */ var _constants_727dee2c_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./constants-727dee2c.js */ "../amplify-ui-components/dist/esm-es5/constants-727dee2c.js");
/* harmony import */ var _helpers_ff1bbc26_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./helpers-ff1bbc26.js */ "../amplify-ui-components/dist/esm-es5/helpers-ff1bbc26.js");
/* harmony import */ var _auth_helpers_4b2fd555_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./auth-helpers-4b2fd555.js */ "../amplify-ui-components/dist/esm-es5/auth-helpers-4b2fd555.js");
...
function () {
  function class_1(hostRef) {
    ...
    this.handleAuthStateChange = _helpers_ff1bbc26_js__WEBPACK_IMPORTED_MODULE_6__["d"];
    /**
        ...
        switch (_a.label) {
          case 0:
            ...
            if (!_aws_amplify_auth__WEBPACK_IMPORTED_MODULE_3__["Auth"] || typeof _aws_amplify_auth__WEBPACK_IMPORTED_MODULE_3__["Auth"].confirmSignIn !== 'function') {
              throw new Error(_constants_727dee2c_js__WEBPACK_IMPORTED_MODULE_5__["N"]);
            }
          ...
          case 2:
            ...
            return [4
            /*yield*/
            , Object(_auth_helpers_4b2fd555_js__WEBPACK_IMPORTED_MODULE_7__["c"])(this.user, this.handleAuthStateChange)];
          ...
          case 4:
            error_1 = _a.sent();
            Object(_helpers_ff1bbc26_js__WEBPACK_IMPORTED_MODULE_6__["a"])(error_1);
            return [3
            /*break*/
            , 6];
...
function () {
  function class_2(hostRef) {
    ...
    this.newFormFields = [];
    this.phoneNumber = {
      countryDialCodeValue: _constants_727dee2c_js__WEBPACK_IMPORTED_MODULE_5__["h"],
  ...
  class_2.prototype.setup = function () {
    ...
    Object(_helpers_ff1bbc26_js__WEBPACK_IMPORTED_MODULE_6__["c"])(this.usernameAlias);
    this.buildFormFields();
  };
  ...
  class_2.prototype.handleFormFieldInputChange = function (fieldType) {
    ...
    switch (fieldType) {
      ...
      case 'phone_number':
        return function (event) {
          return Object(_helpers_ff1bbc26_js__WEBPACK_IMPORTED_MODULE_6__["h"])(event, _this.phoneNumber);
        };
  ...
  class_2.prototype.getUsername = function () {
    ...
    switch (this.usernameAlias) {
      ...
      case 'phone_number':
        return Object(_helpers_ff1bbc26_js__WEBPACK_IMPORTED_MODULE_6__["b"])(this.phoneNumber);
    }
  };
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            error_2 = _a.sent();
            Object(_helpers_ff1bbc26_js__WEBPACK_IMPORTED_MODULE_6__["a"])(error_2);
            return [3
            /*break*/
            , 4];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            return [4
            /*yield*/
            , Object(_auth_helpers_4b2fd555_js__WEBPACK_IMPORTED_MODULE_7__["h"])(username, this._signUpAttrs.password, this.handleAuthStateChange)];
          ...
          case 6:
            error_3 = _a.sent();
            Object(_helpers_ff1bbc26_js__WEBPACK_IMPORTED_MODULE_6__["a"])(error_3);
            return [3
            /*break*/
            , 8];
        ...
        switch (_a.label) {
          case 0:
            ...
            switch (this.usernameAlias) {
              case 'phone_number':
                try {
                  this.forgotPasswordAttrs.userInput = Object(_helpers_ff1bbc26_js__WEBPACK_IMPORTED_MODULE_6__["b"])(this.phoneNumber);
                } catch (error) {
                  Object(_helpers_ff1bbc26_js__WEBPACK_IMPORTED_MODULE_6__["a"])(error);
                }
          ...
          case 3:
            error_4 = _a.sent();
            Object(_helpers_ff1bbc26_js__WEBPACK_IMPORTED_MODULE_6__["a"])(error_4);
            return [3
            /*break*/
            , 5];
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 3:
            error_5 = _b.sent();
            Object(_helpers_ff1bbc26_js__WEBPACK_IMPORTED_MODULE_6__["a"])(error_5);
            return [3
            /*break*/
            , 5];
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            error_6 = _a.sent();
            Object(_helpers_ff1bbc26_js__WEBPACK_IMPORTED_MODULE_6__["a"])(error_6);
            return [3
            /*break*/
            , 4];
          ...
          case 6:
            if (this.currentUser && this.currentUser.challengeParam && this.currentUser.challengeParam.requiredAttributes) {
              ...
              requiredAttributesMap_1 = Object(_helpers_ff1bbc26_js__WEBPACK_IMPORTED_MODULE_6__["g"])();
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 5:
            return [4
            /*yield*/
            , Object(_auth_helpers_4b2fd555_js__WEBPACK_IMPORTED_MODULE_7__["c"])(user, this.handleAuthStateChange)];
          ...
          case 8:
            error_7 = _b.sent();
            Object(_helpers_ff1bbc26_js__WEBPACK_IMPORTED_MODULE_6__["a"])(error_7);
            return [3
            /*break*/
            , 10];
...
function () {
        ...
        switch (_a.label) {
          case 0:
            ...
            switch (this.usernameAlias) {
              case 'phone_number':
                try {
                  this.signInAttributes.userInput = Object(_helpers_ff1bbc26_js__WEBPACK_IMPORTED_MODULE_6__["b"])(this.phoneNumber);
                } catch (error) {
                  Object(_helpers_ff1bbc26_js__WEBPACK_IMPORTED_MODULE_6__["a"])(error);
                }
            ...
            return [4
            /*yield*/
            , Object(_auth_helpers_4b2fd555_js__WEBPACK_IMPORTED_MODULE_7__["h"])(username, this.signInAttributes.password, this.handleAuthStateChange)];
  ...
  class_5.prototype.render = function () {
    ...
    }, !this.hideSignUp ? Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", null, _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(_Translations_97eed81d_js__WEBPACK_IMPORTED_MODULE_4__["T"].NO_ACCOUNT_TEXT), ' ', Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-button", {
      variant: "anchor",
      onClick: function onClick() {
    ...
    }, _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(_Translations_97eed81d_js__WEBPACK_IMPORTED_MODULE_4__["T"].CREATE_ACCOUNT_TEXT))) : Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", null)), Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", {
        ...
        switch (_a.label) {
          case 0:
            ...
            if (this.phoneNumber.phoneNumberValue) {
              try {
                this.signUpAttributes.attributes.phone_number = Object(_helpers_ff1bbc26_js__WEBPACK_IMPORTED_MODULE_6__["b"])(this.phoneNumber);
              } catch (error) {
                Object(_helpers_ff1bbc26_js__WEBPACK_IMPORTED_MODULE_6__["a"])(error);
              }
            }
          ...
          case 2:
            ...
            return [4
            /*yield*/
            , Object(_auth_helpers_4b2fd555_js__WEBPACK_IMPORTED_MODULE_7__["h"])(this.signUpAttributes.username, this.signUpAttributes.password, this.handleAuthStateChange)];
          ...
          case 6:
            error_8 = _a.sent();
            Object(_helpers_ff1bbc26_js__WEBPACK_IMPORTED_MODULE_6__["a"])(error_8);
            return [3
            /*break*/
            , 8];
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            error_9 = _a.sent();
            Object(_helpers_ff1bbc26_js__WEBPACK_IMPORTED_MODULE_6__["a"])(error_9);
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            error_10 = _a.sent();
            Object(_helpers_ff1bbc26_js__WEBPACK_IMPORTED_MODULE_6__["a"])(error_10);
...
/***/ "../amplify-ui-components/dist/esm-es5/auth-helpers-4b2fd555.js":
/*!**********************************************************************!*\
  !*** ../amplify-ui-components/dist/esm-es5/auth-helpers-4b2fd555.js ***!
  \**********************************************************************/
...
/* harmony import */ var _constants_727dee2c_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./constants-727dee2c.js */ "../amplify-ui-components/dist/esm-es5/constants-727dee2c.js");
/* harmony import */ var _helpers_ff1bbc26_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./helpers-ff1bbc26.js */ "../amplify-ui-components/dist/esm-es5/helpers-ff1bbc26.js");
var __awaiter = undefined && undefined.__awaiter || function (thisArg, _arguments, P, generator) {
  function adopt(value) {
    return value instanceof P ? value : new P(function (resolve) {
      resolve(value);
      ...
      switch (_a.label) {
        case 0:
          if (!_aws_amplify_auth__WEBPACK_IMPORTED_MODULE_2__["Auth"] || typeof _aws_amplify_auth__WEBPACK_IMPORTED_MODULE_2__["Auth"].verifiedContact !== 'function') {
            throw new Error(_constants_727dee2c_js__WEBPACK_IMPORTED_MODULE_4__["N"]);
        ...
        case 3:
          error_1 = _a.sent();
          Object(_helpers_ff1bbc26_js__WEBPACK_IMPORTED_MODULE_5__["a"])(error_1);
          return [3
          /*break*/
          , 4];
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 9:
          ...
          Object(_helpers_ff1bbc26_js__WEBPACK_IMPORTED_MODULE_5__["a"])(error_2);
          return [3
          /*break*/
          , 10];
