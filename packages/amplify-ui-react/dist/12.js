...
function () {
  ...
  class_1.prototype.signInWithAmazon = function (event) {
    ...
    window['amazon'].Login.authorize({
      ...
      try {
        window.localStorage.setItem(_constants_727dee2c_js__WEBPACK_IMPORTED_MODULE_5__["j"], JSON.stringify({
          provider: 'amazon'
        }));
      } catch (e) {
  ...
  function class_2(hostRef) {
    ...
    this.handleLoad = function () {
      ...
      _this._auth0.parseHash(function (err, authResult) {
        ...
        try {
          localStorage.setItem(_constants_727dee2c_js__WEBPACK_IMPORTED_MODULE_5__["j"], JSON.stringify(payload));
        } catch (e) {
