...
function () {
  function class_1(hostRef) {
    ...
    this.handleExternalAuthEvent = function (_a) {
      ...
      switch (payload.event) {
        ...
        case 'signIn':
          Object(_auth_helpers_4b2fd555_js__WEBPACK_IMPORTED_MODULE_7__["c"])(payload.data, _helpers_ff1bbc26_js__WEBPACK_IMPORTED_MODULE_6__["d"]);
          break;
        ...
        case 'customGreetingSignOut':
          return Object(_helpers_ff1bbc26_js__WEBPACK_IMPORTED_MODULE_6__["d"])(_this.initialAuthState);
      }
    };
    ...
    this.handleToastEvent = function (_a) {
      ...
      switch (payload.event) {
        case _constants_727dee2c_js__WEBPACK_IMPORTED_MODULE_5__["T"]:
  ...
  class_1.prototype.componentWillLoad = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            Object(_helpers_ff1bbc26_js__WEBPACK_IMPORTED_MODULE_6__["o"])(function (authState, authData) {
              _this.onAuthStateChange(authState, authData);

              _this.toastMessage = '';
            });
            if (!this.hideToast) _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["Hub"].listen(_constants_727dee2c_js__WEBPACK_IMPORTED_MODULE_5__["U"], this.handleToastEvent);
            _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["Hub"].listen(_constants_727dee2c_js__WEBPACK_IMPORTED_MODULE_5__["A"], this.handleExternalAuthEvent);
            Object(_aws_amplify_auth__WEBPACK_IMPORTED_MODULE_3__["appendToCognitoUserAgent"])('amplify-authenticator');
            byHostedUI = localStorage.getItem(_constants_727dee2c_js__WEBPACK_IMPORTED_MODULE_5__["R"]);
            localStorage.removeItem(_constants_727dee2c_js__WEBPACK_IMPORTED_MODULE_5__["R"]);
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        , _aws_amplify_auth__WEBPACK_IMPORTED_MODULE_3__["Auth"].currentAuthenticatedUser().then(function (user) {
          Object(_helpers_ff1bbc26_js__WEBPACK_IMPORTED_MODULE_6__["d"])(_auth_types_caf635db_js__WEBPACK_IMPORTED_MODULE_2__["A"].SignedIn, user);
        })["catch"](function () {
            ...
            return __generator(this, function (_a) {
              switch (_a.label) {
                case 0:
                  ...
                  try {
                    cachedAuthState = localStorage.getItem(_constants_727dee2c_js__WEBPACK_IMPORTED_MODULE_5__["c"]);
                  } catch (error) {
                ...
                case 3:
                  Object(_helpers_ff1bbc26_js__WEBPACK_IMPORTED_MODULE_6__["d"])(this.initialAuthState);
                  return [3
                  /*break*/
                  , 5];
  ...
  class_1.prototype.disconnectedCallback = function () {
    _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["Hub"].remove(_constants_727dee2c_js__WEBPACK_IMPORTED_MODULE_5__["A"], this.handleExternalAuthEvent);
    if (!this.hideToast) _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["Hub"].remove(_constants_727dee2c_js__WEBPACK_IMPORTED_MODULE_5__["U"], this.handleToastEvent);
    return _helpers_ff1bbc26_js__WEBPACK_IMPORTED_MODULE_6__["o"];
  };
