      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            ...
            if (message === _constants_727dee2c_js__WEBPACK_IMPORTED_MODULE_5__["f"] || message === _constants_727dee2c_js__WEBPACK_IMPORTED_MODULE_5__["g"]) {
              this.TOTPSetup = true;
              this.selectMessage = _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(_Translations_97eed81d_js__WEBPACK_IMPORTED_MODULE_4__["T"].SETUP_TOTP_REQUIRED); // 	TODO Add Toast = showToast: true,
            } else {
              logger.debug('Set Preferred MFA failed', error_1);
              this.selectMessage = _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(_Translations_97eed81d_js__WEBPACK_IMPORTED_MODULE_4__["T"].UNABLE_TO_SETUP_MFA_AT_THIS_TIME); // 	TODO Add Toast = showToast: true,
            }
